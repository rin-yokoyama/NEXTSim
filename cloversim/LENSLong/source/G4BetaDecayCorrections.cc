...
//        factor = 1. + c1*w + c2/w + c3*w*w;
        ...
        G4double e_e = std::sqrt(1. + p_e*p_e);// Total electron E
// Option A: 0-
        factor = p_e * p_e + e_nu * e_nu + 2.0 * p_e * p_e * e_nu / e_e;
// Option B: 1- at least o=part of the GT 1- decay
//        factor = p_e * p_e + e_nu * e_nu - 1.333 * p_e * p_e * e_nu / e_e;
//				G4cout <<  e_e << ", " << factor << G4endl;
      }
      break;

    case (uniqueFirstForbidden) :// = FF 2-
      {
