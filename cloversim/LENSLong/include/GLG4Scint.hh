...
/** @file GLG4Scint.hh
    ...
    $Id: GLG4Scint.hh,v 1.2 2005/03/13 06:34:20 GLG4sim Exp $
...
private:
	...
	G4double getExperimentalNaINonlinearity( G4double E ) const;
	G4double getCalcedNonLinearLofEPerStep( G4double dEdx );
